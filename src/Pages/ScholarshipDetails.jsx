...
import { FaStar, FaMapMarkerAlt, FaCalendarAlt, FaDollarSign, FaEye, FaShare, FaBookmark, FaHeart, FaUniversity, FaGraduationCap, FaClock, FaUser, FaComments } from 'react-icons/fa';
import { MdSchool, MdLocationOn, MdAccessTime, MdDescription, MdPayment } from 'react-icons/md';
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-blue-600">${scholarship.applicationFees + scholarship.serviceCharge}</span>
                    </div>
                  </div>
                </div>
