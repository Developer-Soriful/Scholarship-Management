    ...
    <div className="w-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 md:p-10">
        ...
        <p className="text-gray-500 text-center mb-6">
          Create your account. It's free and easy!
        </p>
        <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className="flex items-center justify-center w-full px-4 py-2 bg-white border-2 border-dashed border-blue-400 rounded-lg cursor-pointer hover:bg-blue-50 transition">
                ...
                >
                  <path
                    ...
                    d="M3 16.5V19a2 2 0 002 2h14a2 2 0 002-2v-2.5M16 3.13a4 4 0 010 7.75M8 3.13a4 4 0 010 7.75M12 17v-6m0 0l-3 3m3-3l3 3"
                  />
                </svg>
          ...
          <div>
            ...
            {errorPass && (
              <span className="text-red-500 text-xs">{errorPass}</span>
            )}
          </div>
          {signUpError && (
        ...
        <div className="my-6 flex flex-col items-center gap-2">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 48 48">
              <g>
                <path
                  fill="#4285F4"
                  d="M24 9.5c3.54 0 6.7 1.22 9.19 3.23l6.85-6.85C36.68 2.36 30.74 0 24 0 14.82 0 6.71 5.48 2.69 13.44l7.98 6.2C12.36 13.13 17.74 9.5 24 9.5z"
                />
                <path
                  fill="#34A853"
                ...
                <path
                  fill="#FBBC05"
                  d="M10.67 28.09a14.5 14.5 0 010-8.18l-7.98-6.2A23.97 23.97 0 000 24c0 3.77.9 7.34 2.69 10.29l7.98-6.2z"
                />
                <path
                  fill="#EA4335"
                  d="M24 48c6.48 0 11.93-2.15 15.9-5.85l-7.19-5.6c-2.01 1.35-4.6 2.15-8.71 2.15-6.26 0-11.64-3.63-13.33-8.89l-7.98 6.2C6.71 42.52 14.82 48 24 48z"
                />
              </g>
            </svg>
          ...
          {googleError && (
            <span className="text-red-500 text-xs">{googleError}</span>
          )}
        </div>
