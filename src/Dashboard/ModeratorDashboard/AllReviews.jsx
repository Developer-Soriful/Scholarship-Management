    ...
    return (
        <div className="p-2 sm:p-4 md:p-8 min-h-[75vh] w-full">
            <div className="mb-4 sm:mb-6">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-700 mb-2">All Reviews</h2>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-purple-600">{allRatings.length}</p>
                        </div>
                    </div>
            ...
            {allRatings.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {allRatings.map((rating, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md p-4 border border-purple-100 hover:shadow-lg transition-shadow duration-200">
